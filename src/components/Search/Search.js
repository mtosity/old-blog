...
const LoadingIndicator = connectStateResults(({ isSearchStalled }) => (isSearchStalled ? (
    <div className>
      <BarLoader color="#ffb361"/>
    </div>
) : null));
...
const Search = () => (
  <div className="search">
    <InstantSearch searchClient={algoliaClient} indexName="posts">
      <SearchBox loadingIndicator={BarLoader} showLoadingIndicator={true} />
      <LoadingIndicator />
